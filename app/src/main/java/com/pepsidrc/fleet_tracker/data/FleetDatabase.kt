...
@Database(entities = [UserTbl::class,TaskTbl::class,SubTaskTbl::class,VehicleTbl::class,EmployeeTbl::class,VehiclePartTbl::class,EmiratesTbl::class,VehicleDetailTbl::class, FleetTbl::class, LicenseTbl::class], version = 19)
